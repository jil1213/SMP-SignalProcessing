...
if __name__ == "__main__":
    ...
    # Figures for Results Part 2.1 Alignment 
    # Dictionary of profile names for each day, this is only a example
    profiles_by_day = {
        1: ("S45M1058", "S45M1064"),
        2: ("S45M1084", "S45M1090"),}
    ...
    for day, (name1, name2) in profiles_by_day.items():
        ...
        offset_mm, correlation, lag = get_offset(df1, df2, name1, name2, plot=True)
